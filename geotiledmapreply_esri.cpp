...
static const unsigned char jfifSignature[] = { 0xFF, 0xD8, 0xFF, 0xE0 }; // https://en.wikipedia.org/wiki/List_of_file_signatures
...
void GeoTiledMapReplyEsri::networkReplyFinished()
{
    ...
    else if (imageData.startsWith(reinterpret_cast<const char*>(jfifSignature)))
        setMapImageFormat(QStringLiteral("jpg"));
